...
/* global FilterRule, Log, StringUtils, UrlUtils */
 ...
 */
var UrlFilterRule = (function () {

    'use strict';

    var UrlFilterRule = function (rule) {
    ...
    UrlFilterRule.contentTypes = {
        ...
        GENERICHIDE: 1 << 25,   //CssFilter generic rules cannot be applied to page
        GENERICBLOCK: 1 << 26   //UrlFilter generic rules cannot be applied to page
    };
